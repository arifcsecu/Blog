<form wire:submit="updatePost" class="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-md space-y-4 mb-6">
    @csrf
    ...
    <div class="text-right">
        <button class="bg-green-500 text-white px-5 py-2 rounded-lg hover:bg-green-700 transition">
            Update
        </button>
